...
Para ativar o modo binário, envie o parâmetro "binary_mode" com o valor `true` ao endpoint [/checkout/preferences](/developers/pt/reference/online-payments/checkout-pro/preferences/create-preference/post) e execute a requisição conforme indicado no exemplo abaixo.
